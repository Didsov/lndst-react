    ...
    <footer  className='max-container'>
      <div className='flex justify-between items-start gap-20 flex-wrap max-lg:flex-col'>
        ...
        >
          ...
          Get ready for the term at nearest Nike store. Find Your Store. Get Rewards
          </p>
        ...
        <div className='flex flex-1 w-full justify-between lg:gap-10 gap:20 flex-wrap'>
        ...
        <div className='flex justify-between w-full text-white-400 mt-24 max-sm:flex-col max-sm:items-center'>
            ...
            <p className='font-montserrat cursor-pointer'> Terms & condions</p>
